...
function random()
{
 ...
 if (backgroundoption===true)
 {
    ...
    landingdesign.style.backgroundImage = 'url("img/' +imgarray[randomnumber]  + '")';
...
let bulltscontainer  = document.querySelectorAll(".nav-bullts .bullts");
...
bulltscontainer.forEach(bullet => {
...
let tOpen = document.querySelector(".open");
